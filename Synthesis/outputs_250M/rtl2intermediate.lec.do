...
# Generated on: Fri Jun 12 20:41:24 IST 2026 (Fri Jun 12 15:11:24 UTC 2026)
...
set_log_file logs_250M/rtl2intermediate.lec.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/topmodule1 -revised fv_map
...
read_library -liberty -both /home/vlsi_F13/Desktop/kushwanth_viv/work/../Library/slow.lib /home/vlsi_F13/Desktop/kushwanth_viv/work/../Library/fast.lib /home/vlsi_F13/Desktop/kushwanth_viv/work/../Library/typical.lib /home/vlsi_F13/Desktop/kushwanth_viv/work/../Library/slow.lib /home/vlsi_F13/Desktop/kushwanth_viv/work/../Library/fast.lib /home/vlsi_F13/Desktop/kushwanth_viv/work/../Library/typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../RTL/topmodule1.v ../RTL/fetch_cycle.v ../RTL/execute_cycle.v ../RTL/decode_cycle.v ../RTL/memory_cycle.v ../RTL/ProgramCounter.v ../RTL/instructionmemorybasic.v ../RTL/controlunit.v ../RTL/mux.v ../RTL/mux2.v ../RTL/sign_extend.v ../RTL/registerfileunit.v ../RTL/ALU.v ../RTL/DataMemory.v ../RTL/hazardunit.v ../RTL/mux3to1.v
elaborate_design -golden -root {topmodule1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/topmodule1/fv_map.v.gz
elaborate_design -revised -root {topmodule1}
...
#add_name_alias fv/topmodule1/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box brent_kung_adder dadda_32 -golden
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_250M/rtl2intermediate.lec.log
}
