...
# Generated on: Fri Jun 12 20:44:04 IST 2026 (Fri Jun 12 15:14:04 UTC 2026)
...
set_log_file logs_250M/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information fv_map_topmodule1_mv_db

read_implementation_information fv/topmodule1 -golden fv_map -revised topmodule1_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/topmodule1/fv_map.v.gz
elaborate_design -golden -root {topmodule1}

read_design -verilog95   -revised -lastmod -noelab outputs_250M/topmodule1_m.v
elaborate_design -revised -root {topmodule1}

#add_name_alias fv/topmodule1/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/topmodule1/topmodule1_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_250M/intermediate2final.lec.log
}
